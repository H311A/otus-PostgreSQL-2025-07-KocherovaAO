...
```
Взаимоблокировку удалось воспроизвести. Хотя команда UPDATE всей таблицы выглядит как атомарная операция, механизм ее выполнения (последовательное сканирование и блокировка строк) может при определенных условиях привести к классической взаимоблокировке.
